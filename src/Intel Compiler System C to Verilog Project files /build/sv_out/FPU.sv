...
//------------------------------------------------------------------------------
// Method process: update_stall (FPU.cpp:62:5) 

always_comb 
begin : update_stall     // FPU.cpp:62:5
    internal_stall = stall;
end

//------------------------------------------------------------------------------
// Method process: update_opcode (FPU.cpp:58:5) 

always_comb 
begin : update_opcode     // FPU.cpp:58:5
    opcode = decode_instruction_out[31 : 25];
end

//------------------------------------------------------------------------------
// Method process: update_monitor (FPU.cpp:182:5) 

always_comb 
begin : update_monitor     // FPU.cpp:182:5
    monitor_valid = wb_valid_out;
    monitor_pc = pc_out[7 : 0];
end

//------------------------------------------------------------------------------
// Clocked THREAD: ifu_process (FPU.cpp:66:5) 
...
always_comb begin : ifu_process_comb     // FPU.cpp:66:5
    ifu_process_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: decode_process (FPU.cpp:121:5) 
...
// Next-state combinational logic
always_comb begin : decode_process_comb     // FPU.cpp:121:5
    decode_process_func;
end
...
//------------------------------------------------------------------------------
// Clocked THREAD: reg_file_update (FPU.cpp:167:5) 

// Thread-local variables
logic [31:0] reg_file_next[32];

// Next-state combinational logic
always_comb begin : reg_file_update_comb     // FPU.cpp:167:5
...
//==============================================================================
//
// Module: InstructionMemory (FPU.cpp:53:5)
//
...
//------------------------------------------------------------------------------
// Clocked THREAD: execute_process (execute.h:33:5) 
...
// Next-state combinational logic
always_comb begin : execute_process_comb     // execute.h:33:5
