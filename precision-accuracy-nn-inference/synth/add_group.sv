    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    // NOTE: rewritten from a data-dependent-exit for-loop to a
                    // constant-bound priority search purely so this offline
                    // synthesis experiment can elaborate in yosys; equivalent
                    // leading-zero-count logic, original RTL in the repo is untouched.
                    logic lz_found;
                    lz_found = 0;
                    lz = 24;
                    for (int lz_k = 0; lz_k < 24; lz_k = lz_k + 1)
                    begin
                        if (!lz_found && norm_mantissa[23 - lz_k] == 1'b1)
                        begin
                            lz = lz_k[4:0];
                            lz_found = 1;
                        end
